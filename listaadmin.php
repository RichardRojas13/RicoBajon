				...
				<div id="main" class="wrapper style1">
					<div class="container">
						...
						<?php if(isset($_SESSION['modificar'])) { echo '<p class="mb-0"><i class="fa fa-info-circle mr-5"></i> '. $_SESSION['modificar'] .'</p>'; } ?>
							...
							<section>
								<h3>Lista de juegos actuales</h3>
...
$tecnico = $_SESSION["username"];
								...
								?> 
											<tr>
												...
												<td><a href="/editar?id=<?php echo $row['id'] ?>" class="btn btn-danger ml-3">Editar</a> | <a href="/borrar?id=<?php echo $row['id'] ?>" class="btn btn-danger ml-3">Borrar</a> </a></td>
											</tr>
										<?php	} ?>
										</tbody>
