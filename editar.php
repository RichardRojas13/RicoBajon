...
require_once "config.php";
 $id=$_GET['id'];
foreach ($link->query('SELECT * from juegos WHERE id="'.$id.'"') as $row){ //  ?>
							...
							<section>
								 ...
								 <form action="modj.php" method="post" >
									<div class="row gtr-uniform gtr-50">
										...
										<div class="col-12 col-12-xsmall">
										Imagen del juego:
											<input type="text" name="imagen" id="imagen" value="<?php echo $row['imagen'] ?>" placeholder="Imagen (FORMATO: www.fantasipop.cl/imagen.png)" />
										</div>
										<div class="col-12 col-12-xsmall">
										Qr:
											<input type="text" name="qr" id="qr" value="<?php echo $row['qr'] ?>" placeholder="QR TEXTO" />
										</div>
										
									<div class="col-12">
									Descripcion
											<textarea name="message" id="message" placeholder="<?php echo $row['desk'] ?>" rows="6"><?php echo $row['desk'] ?></textarea>
										</div>
